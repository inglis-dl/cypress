 ...
 * from cypress repository to 12345678.pdf and ensure the
 * test barcode used is 12345678
 */

#include <QDomDocument>

// when running the emulator, set the runnable path and the data path
// to the same location: ie., the "path" below is the working dir of
// the emulator
//
